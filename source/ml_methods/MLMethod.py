...
class MLMethod(metaclass=abc.ABCMeta):
    ...
    py:`source.ml_methods.util.Util.Util.make_binary_class_mapping` method that will automatically create class mapping for binary classification.
    ...
    def get_package_info(self) -> str:
        ...
        implementation. See py:`source.ml_methods.SklearnMethod.SklearnMethod` and py:`source.ml_methods.ProbabilisticBinaryClassifier.ProbabilisticBinaryClassifier`
