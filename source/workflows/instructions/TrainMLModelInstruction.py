...
class TrainMLModelInstruction(Instruction):
    ...
    Arguments:
        ...
        selection (SplitConfig): description of the inner loop (for selection) of nested cross-validation. The same as assessment argument, just to be executed in the inner loop. See :py:obj:`~source.hyperparameter_optimization.config.SplitConfig.SplitConfig`.
