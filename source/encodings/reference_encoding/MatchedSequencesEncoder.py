...
class MatchedSequencesEncoder(DatasetEncoder):
    ...
    Arguments:
        ...
        max_edit_distance (dict): The maximum edit distance between a target sequence (from the repertoire)
        and the reference sequence. A maximum distance can be specified per chain.
