...
class OneHotReceptorEncoder(OneHotEncoder):
    ...
    def _encode_data(self, dataset: ReceptorDataset, params: EncoderParams):
        ...
        examples_first_chain = self._encode_sequence_list(first_chain_seqs, pad_n_sequences=len(receptor_objs), pad_sequence_len=max_seq_len)
        examples_second_chain = self._encode_sequence_list(second_chain_seqs, pad_n_sequences=len(receptor_objs), pad_sequence_len=max_seq_len)
