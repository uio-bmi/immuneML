...
#. Add a new class to the :py:mod:`immuneML.ml_methods.classifiers` package.
   The new class should inherit from the base class :py:obj:`~immuneML.ml_methods.classifiers.MLMethod.MLMethod`.
...
Add a unit test for the new :code:`SillyClassifier` (:download:`download <./example_code/_test_sillyClassifier.py>` the example test file or view below)
