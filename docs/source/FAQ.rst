...
The columns filename and donor are mandatory. Other columns may be defined by the user. There are no restrictions what those should include,
...
the downstream analysis. The prediction target is specified by the name of the column in the DSL specification as the value of the label parameter.
