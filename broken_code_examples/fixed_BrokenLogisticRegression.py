...
class BrokenLogisticRegression(MLMethod):
    ...
    **YAML specification:**
    ...
    def _predict(self, encoded_data: EncodedData):
        self._check_is_fitted(self.label.name)
    ...
    def _predict_proba(self, encoded_data: EncodedData):
        ...
        # fix: add outer dictionary with self.label.name as key
    ...
    # fix warning: check_is_fitted -> _check_is_fitted
    def _check_is_fitted(self, label_name: str):
    ...
    def get_params(self):
        ...
        return params # fix: add return statement
