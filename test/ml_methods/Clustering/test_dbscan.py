...
from immuneML.ml_methods.Clustering.DBSCAN import DBSCAN
...
class TestDBSCAN(TestCase):
    ...
    def test_load(self):
        ...
        self.assertTrue(isinstance(method2.model, SklearnDBSCAN))
