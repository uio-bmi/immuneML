...
from immuneML.ml_methods.Clustering.AffinityPropagation import AffinityPropagation
...
class TestAffinityPropagation(TestCase):
    ...
    def test_load(self):
        ...
        method2 = AffinityPropagation()
        method2.load(path)

        self.assertTrue(isinstance(method2.model, SklearnAffinityPropagation))
