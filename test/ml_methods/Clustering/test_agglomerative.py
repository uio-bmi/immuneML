...
from immuneML.ml_methods.Clustering.Agglomerative import Agglomerative
from immuneML.util.PathBuilder import PathBuilder


class TestAgglomerative(TestCase):
    ...
    def test_load(self):
        ...
        method2 = Agglomerative()
        method2.load(path)

        self.assertTrue(isinstance(method2.model, SklearnAgglomerative))
