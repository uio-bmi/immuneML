...
from immuneML.ml_methods.Clustering.KMedoids import KMedoids
...
class TestDBSCAN(TestCase):
    ...
    def test_load(self):
        ...
        self.assertTrue(isinstance(method2.model, SklearnKMedoids))
