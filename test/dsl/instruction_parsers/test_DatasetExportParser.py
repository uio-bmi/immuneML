...
class TestDatasetExportParser(TestCase):
    def test_parse_no_preproc(self):
        specs = {"type": "DatasetExport", "export_formats": ["Binary", "AIRR"], "datasets": ["d1"]}
    ...
    def test_parse_preproc(self):
        specs = {"type": "DatasetExport", "export_formats": ["Binary", "AIRR"], "datasets": ["d1"], "preprocessing_sequence": "p1"}
