...
from immuneML.dsl.instruction_parsers.ClusteringParser import ClusteringParser
...
class TestClusteringParser(TestCase):
    ...
    def test_parse(self):
        ...
        path = EnvironmentSettings.tmp_test_path / "clusteringparser/"
