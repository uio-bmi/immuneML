...
class TestGappedMotifImplanting(TestCase):
    def test_implant(self):
        ...
        sequence = strategy.implant(ReceptorSequence(amino_acid_sequence="AAAAAAAAAA", metadata=SequenceMetadata(region_type='IMGT_CDR3')),
                                    {"signal_id": "1", "motif_id": "1", "motif_instance": motif_instance})
