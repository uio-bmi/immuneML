...
class TestGappedKmerInstantiation(TestCase):
    def test_instantiate_motif(self):
        ...
        instance = strategy.instantiate_motif("C/AS", params={"position_weights": {0: 1, 1: 1, 2: 0, 3: 0}, # 1:1 is not allowed (gap position), should be filtered internally
                                                              "alphabet_weights": {"T": 0.5, "F": 0.5, "A": 0, "C": 0,
                                                                                   "D": 0, "E": 0, "G": 0, "H": 0,
                                                                                   "K": 0, "I": 0, "L": 0, "M": 0,
                                                                                   "N": 0, "P": 0, "Q": 0, "R": 0,
                                                                                   "S": 0, "V": 0, "W": 0, "Y": 0}})
        ...
        instance = strategy.instantiate_motif("CAS", params={"position_weights": {0: 1, 1: 0, 2: 0},
                                                             "alphabet_weights": {"T": 0.5, "F": 0.5, "A": 0, "C": 0,
                                                                                  "D": 0, "E": 0, "G": 0, "H": 0,
                                                                                  "K": 0, "I": 0, "L": 0, "M": 0,
                                                                                  "N": 0, "P": 0, "Q": 0, "R": 0,
