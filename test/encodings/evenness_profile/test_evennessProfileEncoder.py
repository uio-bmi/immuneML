...
class TestEvennessEncoder(TestCase):
    def test_encode(self):
        ...
        rep1 = Repertoire.build_from_sequence_objects(sequence_objects=[ReceptorSequence("AAA", metadata=SequenceMetadata(count=10)) for i in range(1000)] +
        ...
        rep2 = Repertoire.build_from_sequence_objects(sequence_objects=[ReceptorSequence("AAA", metadata=SequenceMetadata(count=10)) for i in range(1000)],
