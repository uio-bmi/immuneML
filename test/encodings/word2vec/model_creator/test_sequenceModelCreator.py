...
class TestSequenceModelCreator(TestCase):
    def test_create_model(self):
        ...
        metadata1 = {"T1D": "T1D"}
        rep1 = SequenceRepertoire.build_from_sequence_objects([sequence1, sequence2], metadata=metadata1, path=test_path, identifier="1")

        metadata2 = {"T1D": "CTL"}
        rep2 = SequenceRepertoire.build_from_sequence_objects([sequence1], metadata=metadata2, path=test_path, identifier="2")
