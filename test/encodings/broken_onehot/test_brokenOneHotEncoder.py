...
from immuneML.encodings.broken_encoder.BrokenOneHotEncoder import BrokenOneHotEncoder
...
class TestBrokenOneHotEncoder(TestCase):
    ...
    def test(self):
        ...
        encoder = BrokenOneHotEncoder.build_object(dataset, **{"flatten": False})
    ...
    def test_sequence_flattened(self):
        ...
        encoder = BrokenOneHotEncoder.build_object(dataset, **{"flatten": True})
