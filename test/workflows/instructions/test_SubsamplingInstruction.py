...
class TestSubsamplingInstruction(TestCase):
    def test_run(self):
        ...
        inst = SubsamplingInstruction(dataset=dataset, subsampled_dataset_sizes=[100, 50], dataset_export_formats=[BinaryExporter],
        ...
        self.assertTrue(all(os.path.isfile(state.subsampled_dataset_paths[name]['binary'])
