...
class TestSignalImplanter(TestCase):
    ...
    def test_run(self):
        ...
        sequences = [ReceptorSequence("ACDEFG", identifier="1", metadata=SequenceMetadata(region_type='IMGT_CDR3')),
                     ReceptorSequence("ACDEFG", identifier="2", metadata=SequenceMetadata(region_type='IMGT_CDR3')),
                     ReceptorSequence("ACDEFG", identifier="3", metadata=SequenceMetadata(region_type='IMGT_CDR3')),
                     ReceptorSequence("ACDEFG", identifier="4", metadata=SequenceMetadata(region_type='IMGT_CDR3'))]
