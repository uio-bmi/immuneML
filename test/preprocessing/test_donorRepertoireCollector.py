...
class TestDonorRepertoireCollector(TestCase):

    def setUp(self) -> None:
        os.environ[Constants.CACHE_TYPE] = CacheType.TEST.name

    def test_process(self):
        path = EnvironmentSettings.root_path + "test/tmp/donor_rep_collector/"
        ...
        dataset2 = DonorRepertoireCollector.process(dataset, {"result_path": path + "result/"})
