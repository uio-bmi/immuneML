...
class OneHotEncoder(DatasetEncoder):
    ...
    Arguments:
        ...
        This must be set to True when using onehot encoding in combination with scikit-learn ML methods (inheriting :py:obj:`~immuneML.ml_methods.SklearnMethod.SklearnMethod`),
